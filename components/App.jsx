          ...
          >
            ...
            <div className="order-2 md:order-1 bg-primary-50 dark:bg-primary-900 text-primary-400 dark:text-white text-xs sm:text-sm py-1 sm:py-2 px-2.5 sm:px-4 border-b border-primary-200 dark:border-white/30 transition-colors relative overflow-visible">
              <div className="max-w-7xl mx-auto flex justify-between items-center gap-2">
                ...
                {/* Desktop mega-nav */}
                <nav className="hidden md:flex items-center gap-1 lg:gap-2 flex-1 justify-start min-w-0 overflow-x-auto no-scrollbar max-w-full">
                  ...
                  <button type="button" onClick={() => openStaticPage('about')} className="hidden xl:inline-flex px-2 lg:px-2.5 py-1 rounded-md text-primary-500 dark:text-white hover:text-primary-800 dark:hover:text-white hover:bg-primary-100/60 dark:hover:bg-primary-800/60 transition whitespace-nowrap text-xs lg:text-sm">درباره ما</button>
                  ...
                  <button type="button" onClick={() => openStaticPage('deals')} className="hidden xl:inline-flex px-2 lg:px-2.5 py-1 rounded-md text-primary-500 dark:text-white hover:text-primary-800 dark:hover:text-white hover:bg-primary-100/60 dark:hover:bg-primary-800/60 transition whitespace-nowrap text-xs lg:text-sm">شگفت‌انگیز</button>
                  <button type="button" onClick={() => openStaticPage('brands')} className="hidden xl:inline-flex px-2 lg:px-2.5 py-1 rounded-md text-primary-500 dark:text-white hover:text-primary-800 dark:hover:text-white hover:bg-primary-100/60 dark:hover:bg-primary-800/60 transition whitespace-nowrap text-xs lg:text-sm">برندها</button>
                </nav>
