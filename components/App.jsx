...
import ContentSeoBox from '@/components/ContentSeoBox';
      ...
      const upsertRankKeyword = (keyword, position, url = '') => {
        ...
        if (idx >= 0) {
          ...
          list.unshift({
           ...
           // renderContentSeoBox → components/ContentSeoBox.jsx
      const renderContentSeoBox = (opts) => (
        <ContentSeoBox
          {...(opts || {})}
          _seoHelpers={{
            seoCfg,
            seoPixelReport: typeof seoPixelReport !== 'undefined' ? seoPixelReport : undefined,
            aiGenerateSeoMeta,
            aiSuggestFaq,
            suggestInternalLinks,
            getSeoAiQuotaState: typeof getSeoAiQuotaState !== 'undefined' ? getSeoAiQuotaState : undefined,
            checkSellerSeoSpam: typeof checkSellerSeoSpam !== 'undefined' ? checkSellerSeoSpam : undefined,
            pushLiveToast: typeof pushLiveToast !== 'undefined' ? pushLiveToast : undefined,
          }}
        />
      );
