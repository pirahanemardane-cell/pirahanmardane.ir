...
{/* ===================== PLP — لیست محصولات ===================== */}
      ...
      {roleGateOpen ? (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4" dir="rtl" role="dialog" aria-modal="true">
          ...
          <div className="relative z-10 w-full max-w-md rounded-none border border-primary-200 dark:border-white/15 bg-white dark:bg-[#1a1c20] shadow-2xl p-6 sm:p-8" style={{ borderRadius: 0 }}>
