          ...
          >
            ...
            <div className="order-1 md:order-2 max-w-7xl mx-auto px-3 sm:px-4 py-1.5 sm:py-2.5 w-full">
              <div className="flex items-center gap-2 sm:gap-3 flex-row">
                ...
                <div className="hidden md:block flex-1 min-w-0 max-w-xl mx-auto relative order-2 z-20">
...
{/* ===================== PLP — لیست محصولات ===================== */}
      ...
      {roleGateOpen ? (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4" dir="rtl" role="dialog" aria-modal="true">
          ...
          <div className="relative z-10 w-full max-w-md rounded-3xl border border-primary-200 dark:border-white/15 bg-white dark:bg-[#1a1c20] shadow-2xl p-6 sm:p-8">
