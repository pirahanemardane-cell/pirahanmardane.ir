...
const VirtualProductGrid = dynamic(() => import('./VirtualProductGrid'), {
  ssr: false,
  loading: () => <div className="min-h-[120px] flex items-center justify-center" role="status"><span className="text-sm text-primary-500 animate-pulse">در حال بارگذاری…</span></div>,
});
const SimpleEditor = dynamic(() => import('./SimpleEditor'), {
  ssr: false,
  loading: () => (
    <div className="min-h-[120px] flex items-center justify-center" role="status"><span className="text-sm text-primary-500 animate-pulse">در حال بارگذاری…</span></div>
  ),
});
      ...
      const renderProductCard = useCallback((p, keyPrefix = '', opts = {}) => { /* card-height-v2 */
        ...
        return (
          <div
            ...
            className={`gsap-card product-card pm-soft-enter bg-white dark:bg-black rounded-xl sm:rounded-2xl overflow-hidden shadow-sm flex flex-col cursor-pointer select-none border border-primary-100/80 dark:border-white/10 ${gridMode ? 'w-full h-full' : 'flex-shrink-0 w-[78%] min-[400px]:w-[70%] sm:w-[42%] md:w-[calc((100%-2.5rem)/3.3)] lg:w-[calc((100%-3.5rem)/4.3)] snap-start'}`}
          >
            <div className="px-2.5 pt-2 sm:px-2.5 sm:pt-2 sm:pb-0">
              ...
              <div className="mt-1 flex flex-col items-start gap-0.5 min-h-[2.5rem] sm:min-h-[2.25rem]">
                <button
                  ...
                  className="product-seller-badge inline-flex items-center gap-1 h-6 sm:h-7 px-1.5 sm:px-2 rounded-md bg-primary-900 dark:bg-primary-700 text-white dark:!text-white text-xs font-bold whitespace-nowrap max-w-full transition border border-primary-900 dark:border-white/25 cursor-pointer hover:opacity-90"
          ...
          {(pageLoadingText || (awaitingDeepProduct && !pdpProduct)) ? (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 dark:bg-black/55 backdrop-blur-[2px]" role="status" aria-live="polite">
              <div className="flex flex-col items-center gap-3 px-6 py-5 rounded-2xl min-w-[200px] shadow-2xl border bg-[#FF0000] border-[#FF0000] text-white dark:bg-[#13ABC4] dark:border-[#13ABC4] dark:text-[#0A0A0A]">
                <p
                  className="pm-page-loader-text text-sm font-bold tracking-wide text-center"
                  style={{ color: 'var(--pm-loader-fg, #ffffff)', WebkitTextFillColor: 'var(--pm-loader-fg, #ffffff)' }}
                >
            ...
            <div className="order-2 md:order-1 bg-primary-50 dark:bg-primary-900 text-primary-400 dark:text-white text-xs sm:text-sm py-1 sm:py-2 px-2.5 sm:px-4 border-b border-primary-200 dark:border-white/30 transition-colors relative overflow-visible">
              <div className="max-w-7xl mx-auto flex justify-between items-center gap-2">
                ...
                <nav className="hidden md:flex items-center gap-0.5 lg:gap-1.5 flex-1 justify-start min-w-0 overflow-x-auto no-scrollbar max-w-full">
                  ...
                  <button type="button" onClick={() => openStaticPage('about')} className="hidden md:inline-flex px-2 lg:px-2.5 py-1 rounded-md text-primary-500 dark:text-white hover:text-primary-800 dark:hover:text-white hover:bg-primary-100/60 dark:hover:bg-primary-800/60 transition whitespace-nowrap text-xs lg:text-sm">درباره ما</button>
                ...
                <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 relative z-10 ps-2 ms-1 border-s border-primary-200/80 dark:border-white/20">
                  {user ? (
                    <button
                      type="button"
                    ...
                    {sellerUser ? (
                      ...
                      >
                        ...
                        <span className="hidden sm:inline text-xs lg:text-sm whitespace-nowrap">ورود</span>
