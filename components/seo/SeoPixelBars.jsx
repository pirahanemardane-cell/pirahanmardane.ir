...
export default function SeoPixelBars({ report }) {
  ...
  const bar = (ratio, over) => (
    <div className="h-1.5 rounded-full bg-primary-200 bg-white/15 overflow-hidden flex-1 min-w-[4rem]">
      <div
  ...
  return (
    <div className="mt-1.5 space-y-1">
      <div className="flex items-center gap-2 text-[10px] text-primary-500 text-white/60">
      ...
      <p className="text-[10px] text-primary-400 text-white/50">
