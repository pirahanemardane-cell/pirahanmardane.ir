...
const Input = React.forwardRef(function Input({ className, type = 'text', ...props }, ref) {
  return (
    <input
      type={type}
      className={cn(
        'flex h-11 w-full rounded-xl border border-primary-200 border-white/20',
        'bg-white bg-[#212121] px-3 py-2.5 text-sm text-primary-900 text-white',
        'placeholder:text-primary-400 placeholder:text-white/40',
