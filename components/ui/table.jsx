  ...
  return (
    <div
      className={cn(
        ...
        'rounded-2xl border border-black/5 border-white/10',
        'bg-white bg-[#121214]',
        'shadow-[0_1px_2px_rgba(0,0,0,0.04)] shadow-none'
      )}
    >
      <table
        ref={ref}
        className={cn(
          'w-full caption-bottom text-sm text-primary-900 text-white border-collapse',
          className
        )}
        {...props}
      />
...
const TableHeader = React.forwardRef(function TableHeader({ className, ...props }, ref) {
  return (
    <thead
      ...
      className={cn(
        'bg-[#F7F7F8] bg-[#1A1C20]',
        '[&_tr]:border-b [&_tr]:border-black/5 [&_tr]:border-white/10',
        className
      )}
      {...props}
    />
  ...
  return (
    <tbody
      ...
      className={cn(
        ...
        '[&_tr:nth-child(even)]:bg-[#FAFAFB] [&_tr:nth-child(even)]:bg-white/[0.02]',
        className
      )}
      {...props}
    />
...
const TableFooter = React.forwardRef(function TableFooter({ className, ...props }, ref) {
  return (
    <tfoot
      ref={ref}
      className={cn(
        'border-t border-black/5 border-white/10',
        'bg-[#F7F7F8] bg-[#1A1C20] font-medium',
        '[&>tr]:last:border-b-0',
        className
      )}
      {...props}
...
const TableRow = React.forwardRef(function TableRow({ className, ...props }, ref) {
  return (
    <tr
      ref={ref}
      className={cn(
        'border-b border-black/[0.06] border-white/[0.08]',
        'transition-colors duration-150',
        'hover:bg-[#F3F4F6] hover:bg-white/[0.04]',
        'data-[state=selected]:bg-[#4CCD99]/8 data-[state=selected]:bg-[#4CCD99]/15',
        className
      )}
      {...props}
    />
  ...
  return (
    <td
      ...
      className={cn(
        ...
        'text-sm text-primary-800 text-white/90',
        className
      )}
      {...props}
    />
...
const TableCaption = React.forwardRef(function TableCaption({ className, ...props }, ref) {
  return (
    <caption
      ref={ref}
      className={cn('mt-3 text-sm text-primary-500 text-white/50', className)}
      {...props}
    />
  );
});
