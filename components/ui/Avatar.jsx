...
export default function Avatar({
  ...
  return (
    <div
      ...
      className={`flex items-center justify-center flex-shrink-0 select-none bg-primary-100 text-primary-800 bg-primary-800 text-white border border-primary-200/80 border-white/15 ${className}`.trim()}
      style={{
        width: dim,
        height: dim,
        borderRadius: radius,
