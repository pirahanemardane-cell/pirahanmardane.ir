...
/** تغییر رنگ یک خط سبد؛ در صورت وجود خط هم‌رنگ، qty ادغام می‌شود */
export function changeCartLineColor(cart, { id, oldColorName, newColor }) {
  const prev = Array.isArray(cart) ? cart : [];
