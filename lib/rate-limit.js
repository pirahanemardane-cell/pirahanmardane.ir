...
export const RATE_POLICIES = {
  // OTP: سقف سخت‌تر برای جلوگیری از سوءاستفاده SMS
  otp_phone: { limit: 4, windowMs: 15 * 60 * 1000 },
  otp_ip: { limit: 12, windowMs: 15 * 60 * 1000 },
  otp_verify_phone: { limit: 10, windowMs: 15 * 60 * 1000 },
  otp_verify_ip: { limit: 25, windowMs: 15 * 60 * 1000 },
  login_id: { limit: 8, windowMs: 15 * 60 * 1000 },
  login_ip: { limit: 20, windowMs: 15 * 60 * 1000 },
  order_user: { limit: 15, windowMs: 60 * 60 * 1000 },
  pay_user: { limit: 20, windowMs: 60 * 60 * 1000 },
  api_ip: { limit: 100, windowMs: 60 * 1000 },
  mfa: { limit: 6, windowMs: 15 * 60 * 1000 },
}
