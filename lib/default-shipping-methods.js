...
/** تبدیل پاسخ API روش‌های ارسال به شکل UI */
export function mapShippingMethodsFromApi(items) {
...
/** payload برای POST /api/shipping-methods */
export function shippingMethodsToApiPayload(list) {
