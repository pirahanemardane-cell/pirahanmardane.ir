...
old1 = 'className="product-seller-badge inline-flex items-center gap-1 h-6 sm:h-7 px-1.5 sm:px-2 rounded-md bg-primary-100 bg-primary-700 text-primary-900 !text-white text-xs font-semibold whitespace-nowrap max-w-full transition border border-primary-200/80 border-white/25 cursor-pointer hover:opacity-90"'
new1 = 'className="product-seller-badge inline-flex items-center gap-1 h-6 sm:h-7 px-1.5 sm:px-2 rounded-md bg-primary-900 bg-white text-white !text-primary-900 text-xs font-bold whitespace-nowrap max-w-full transition border border-primary-900 border-white cursor-pointer hover:opacity-90"'
if old1 in t:
